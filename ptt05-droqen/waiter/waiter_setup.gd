...
export var rcontrol_button1 : String = ""
export var rcontrol_button2 : String = ""
export var rcontrol_button3 : String = ""
export var rcontrol_button4 : String = ""
...
func _ready():
	if not Engine.editor_hint:
		...
		if rcontrol_numpad:
			...
			if rcontrol_button1: print("r1: "+rcontrol_button1) # report
			if rcontrol_button2: print("r1: "+rcontrol_button2) # report
			if rcontrol_button3: print("r1: "+rcontrol_button3) # report
			if rcontrol_button4: print("r1: "+rcontrol_button4) # report
